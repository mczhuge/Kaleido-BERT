...
3) If you feel hard to download these datasets, you can modify /dataset/get_pretrain_data.sh, /dataset/get_pretrain_data.sh, /dataset/get_pretrain_data.sh, and comment out ‘wget http://XXX’ as you want.
